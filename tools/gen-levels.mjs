...
const CONFIGS = [
  ...
  { name: 'LEVEL 2: OUTPOST', w: 52, h: 34, rooms: 12, key: 'blue', doors: 3, terminals: 2,
  ...
  { name: 'LEVEL 6: THE WOUND', w: 62, h: 46, rooms: 18, key: 'yellow', doors: 5, terminals: 2,
  ...
  { name: 'LEVEL 9: ICON', w: 70, h: 54, rooms: 22, key: 'yellow', doors: 7, wastePool: true,
