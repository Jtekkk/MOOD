...
const CONFIGS = [
  { name: 'LEVEL 1: ENTRYWAY', w: 54, h: 36, rooms: 11, key: 'red', doors: 2,
    theme: { primary: '#', accents: ['C', 'L', 'M', 'P'] }, floor: 'floor', ceil: 'ceil', sky: '#20242c',
    enemies: { z: 7, i: 4 }, barrels: 4, lamps: 10,
    items: { h: 4, H: 2, p: 4, a: 1, l: 4, L: 2, s: 3, S: 1 } },
  { name: 'LEVEL 2: OUTPOST', w: 58, h: 40, rooms: 13, key: 'blue', doors: 3, terminals: 2,
    theme: { primary: 'M', accents: ['P', 'H', 'Z', 'C', 'F'] }, floor: 'grate', ceil: 'ceil', sky: '#23201a',
    enemies: { z: 7, i: 6, d: 2 }, water: { ponds: 1 }, weapons: ['2'], barrels: 5, lamps: 11,
    items: { h: 4, H: 2, p: 4, a: 1, A: 1, l: 3, L: 3, s: 3, S: 2 } },
  { name: 'LEVEL 3: THE ASCENT', w: 62, h: 44, rooms: 14, key: 'yellow', doors: 3,
    theme: { primary: 'S', accents: ['C', 'L', 'M', 'V'] }, floor: 'floor2', ceil: 'ceil', sky: '#1b2028',
    enemies: { z: 6, i: 7, d: 3, f: 2 }, outdoor: 1, water: { ponds: 1 }, weapons: ['3'], barrels: 4, lamps: 12, dais: 2, ceils: 1,
    items: { h: 5, H: 3, p: 4, a: 1, A: 1, l: 3, L: 3, s: 3, S: 2, r: 1, e: 2 } },
  { name: 'LEVEL 4: REFINERY', w: 66, h: 46, rooms: 16, key: 'red', doors: 4,
    theme: { primary: 'A', accents: ['K', 'X', 'S', 'V', 'J'] }, floor: 'blood', ceil: 'ceil', sky: '#2a1414',
    enemies: { z: 7, i: 8, d: 3, c: 2 }, outdoor: 1, water: { ponds: 1, streams: 1 }, weapons: ['4'], barrels: 5, lamps: 13,
    items: { h: 5, H: 3, p: 5, a: 1, A: 1, l: 3, L: 3, s: 3, S: 3, r: 2, e: 2, b: 1, u: 1 } },
  { name: 'LEVEL 5: FOUNDRY', w: 70, h: 50, rooms: 17, key: 'blue', doors: 4, boss: 'n',
    theme: { primary: 'Z', accents: ['M', 'P', 'H', 'C', 'F'] }, floor: 'floor2', ceil: 'ceil', sky: '#1e1a18',
    enemies: { z: 6, i: 8, d: 4, c: 3, f: 2, m: 1 }, outdoor: 1, weapons: ['5'], barrels: 6, lamps: 14, secret: 1, secretReward: 'g',
    items: { h: 6, H: 3, p: 5, a: 1, A: 1, g: 1, l: 3, L: 3, s: 4, S: 3, r: 2, e: 3, u: 1 } },
  { name: 'LEVEL 6: THE WOUND', w: 72, h: 54, rooms: 19, key: 'yellow', doors: 5, terminals: 2,
    theme: { primary: 'T', accents: ['Q', 'C', 'L', 'A', 'K'] }, floor: 'tile', ceil: 'ceil', sky: '#241a2a',
    enemies: { z: 6, i: 8, d: 4, c: 3, f: 3, x: 2, w: 1, m: 1, q: 1 }, outdoor: 1, water: { ponds: 1 }, weapons: ['6'], barrels: 6, lamps: 15, dais: 2, ceils: 1,
    items: { h: 6, H: 4, p: 6, a: 1, A: 1, l: 4, L: 4, s: 4, S: 3, r: 2, e: 3, E: 2 } },
  { name: 'LEVEL 7: RUSTWORKS', w: 76, h: 56, rooms: 20, key: 'red', doors: 5,
    theme: { primary: '#', accents: ['C', 'M', 'P', 'L', 'F'] }, floor: 'floor', ceil: 'ceil', sky: '#1c2026',
    enemies: { z: 6, i: 9, d: 4, c: 4, f: 3, B: 1, w: 2, q: 1 }, outdoor: 1, water: { ponds: 2, streams: 1 }, weapons: ['5'], barrels: 7, lamps: 16, secret: 1, secretReward: 'V',
    items: { v: 1, h: 6, H: 4, p: 6, a: 1, A: 1, l: 4, L: 4, s: 4, S: 4, r: 3, e: 3, E: 2, I: 1, "0": 1 } },
  { name: 'LEVEL 8: CRYPTWORKS', w: 80, h: 60, rooms: 21, key: 'blue', doors: 6,
    theme: { primary: 'S', accents: ['X', 'V', 'B', 'A', 'J'] }, floor: 'floor2', ceil: 'ceil', sky: '#1c1d24',
    enemies: { z: 5, i: 9, d: 5, c: 4, f: 3, B: 1, x: 2, P: 1, j: 1, w: 2, m: 2, q: 2 }, outdoor: 1, weapons: ['6'], barrels: 6, lamps: 17, dais: 2, ceils: 1,
    items: { h: 7, H: 4, p: 6, a: 1, A: 1, g: 1, k: 1, l: 4, L: 4, s: 4, S: 4, r: 3, e: 4, E: 3, b: 1, I: 1, "0": 1 } },
  { name: 'LEVEL 9: ICON', w: 84, h: 64, rooms: 23, key: 'yellow', doors: 7, wastePool: true,
    theme: { primary: 'T', accents: ['Q', 'C', 'L', 'A', 'K', 'J'] }, floor: 'tile', ceil: 'ceil', sky: '#241a2a',
    enemies: { z: 5, i: 10, d: 6, c: 5, f: 4, B: 2, x: 2, P: 2, j: 2, w: 3, m: 3, q: 2 }, outdoor: 1, water: { ponds: 2, streams: 1 }, weapons: ['6', '5', '7'], barrels: 8, lamps: 18, dais: 2, ceils: 1, secret: 1, secretReward: '7',
    items: { V: 1, k: 1, v: 1, h: 8, H: 5, p: 7, a: 1, A: 1, g: 1, l: 5, L: 5, s: 5, S: 5, r: 4, e: 4, E: 4, b: 1, u: 1, I: 1 } },
];
...
function genLevel(cfg, seed) {
  ...
  // wall-mounted D.I. access terminals ('t'), placed against a wall, off chokes
  if (cfg.terminals) {
    const wallAdj = (x, y) => [[1, 0], [-1, 0], [0, 1], [0, -1]].some(([dx, dy]) => g[y + dy] && g[y + dy][x + dx] && g[y + dy][x + dx] !== '.');
    let placed = 0;
    for (let i = floorCells.length - 1; i >= 0 && placed < cfg.terminals; i--) {
      const [x, y] = floorCells[i];
      if (occupied.has(`${x},${y}`) || isChoke(x, y) || !wallAdj(x, y)) continue;
      occupied.add(`${x},${y}`); t[y][x] = 't'; floorCells.splice(i, 1); placed++;
    }
  }

  // LEVEL 9's guaranteed hazardous sludge pool: flood a large interior room and
  // record it so the runtime can drain it (D.I. terminal option 6) and reveal
  // the rewards inside.
  let wastePool = null;
  if (cfg.wastePool) {
    const cand = rooms.slice(1, rooms.length - 1).filter((r) => r.w >= 4 && r.h >= 4).sort((a, b) => (b.w * b.h) - (a.w * a.h));
    const r = cand[0];
    if (r) {
      for (let y = r.y; y < r.y + r.h; y++) for (let x = r.x; x < r.x + r.w; x++) setTerr(x, y, '~');
      wastePool = { x: r.x, y: r.y, w: r.w, h: r.h };
    }
  }
  ...
  return {
    ...
    ceils: cg.map((row) => row.join('')), wastePool,
  };
}
...
for (const lv of levels) {
  const wp = lv.wastePool ? `\n    wastePool: { x: ${lv.wastePool.x}, y: ${lv.wastePool.y}, w: ${lv.wastePool.w}, h: ${lv.wastePool.h} },` : '';
  src += `  {\n    name: '${lv.name}',\n    floor: '${lv.floor}', ceil: '${lv.ceil}', skyTint: '${lv.sky}',\n    startAngle: ${lv.startAngle},${wp}\n    walls: [\n${esc(lv.walls)},\n    ],\n    things: [\n${esc(lv.things)},\n    ],\n    terrain: [\n${esc(lv.terrain)},\n    ],\n    heights: [\n${esc(lv.heights)},\n    ],\n    ceils: [\n${esc(lv.ceils)},\n    ],\n  },\n`;
}
src += `];\n`;
