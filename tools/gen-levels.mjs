...
const CONFIGS = [
  ...
  { name: 'LEVEL 6: THE WOUND', w: 62, h: 46, rooms: 18, key: 'yellow', doors: 5,
    ...
    enemies: { z: 4, i: 6, d: 3, c: 2, f: 2, x: 1, w: 1 }, outdoor: 1, water: { ponds: 1 }, weapons: ['6'], barrels: 6, lamps: 15, dais: 2, ceils: 1,
  ...
  { name: 'LEVEL 8: CRYPTWORKS', w: 66, h: 50, rooms: 20, key: 'blue', doors: 6,
    ...
    enemies: { z: 3, i: 7, d: 4, c: 3, f: 2, B: 1, x: 1, P: 1, j: 1, w: 2 }, outdoor: 1, weapons: ['6'], barrels: 6, lamps: 17, dais: 2, ceils: 1,
    items: { h: 7, H: 4, p: 6, a: 1, A: 1, g: 1, k: 1, l: 4, L: 4, s: 4, S: 4, r: 3, e: 4, E: 3 } },
  { name: 'LEVEL 9: ICON', w: 70, h: 54, rooms: 22, key: 'yellow', doors: 7,
    theme: { primary: 'T', accents: ['Q', 'C', 'L', 'A', 'K'] }, floor: 'tile', ceil: 'ceil', sky: '#241a2a',
    enemies: { z: 3, i: 7, d: 4, c: 4, f: 3, B: 2, x: 2, P: 1, j: 2, w: 3 }, outdoor: 1, water: { ponds: 2, streams: 1 }, weapons: ['6', '5', '7'], barrels: 8, lamps: 18, dais: 2, ceils: 1, secret: 1, secretReward: '7',
